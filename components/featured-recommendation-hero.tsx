  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden rounded-[2rem]">
        <div
          className="absolute -left-1/4 top-1/2 h-[min(100%,28rem)] w-[min(140%,42rem)] -translate-y-1/2 rounded-full bg-white/[0.04] blur-[100px]"
          aria-hidden
        />
        <div
          className="absolute -right-1/4 top-0 h-[min(90%,24rem)] w-[min(120%,36rem)] rounded-full bg-white/[0.035] blur-[90px]"
          aria-hidden
        />
        <div
          className="absolute bottom-0 left-1/3 h-48 w-64 rounded-full bg-white/[0.03] blur-[80px]"
          aria-hidden
        />
      </div>

      <div className="relative rounded-[2rem] border border-white/[0.08] bg-[#1a1a1a]/95 px-6 py-12 shadow-[0_0_0_1px_rgba(255,255,255,0.06)] backdrop-blur-sm sm:px-10 sm:py-14 md:px-14 md:py-16">
        <p
        ...
        <div className="mx-auto mt-12 flex max-w-3xl flex-col items-center gap-6 border-t border-white/[0.06] pt-10 sm:flex-row sm:items-center sm:justify-center sm:gap-8">
          ...
          <div className="text-center sm:text-left">
            ...
            <p className="mt-1.5 text-[1rem] leading-snug text-muted">{title}</p>
          </div>
        </div>
      </div>
    </motion.section>
